...
export function SubforumCard({ name, subforumId, icon }: SubforumCardProps) {
  ...
  return (
    <div className="py-4 px-4 gap-2 border border-gray-300 rounded-lg hover:underline hover:text-medium hover:bg-[#edf4f2] cursor-pointer transition-colors" onClick={handleClick}>
