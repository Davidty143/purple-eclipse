...
const BodyHeader = () => {
  return (
    <div className="p-body-header border-1 px-5 py-3 rounded-md">
      ...
      <div className="p-description text-sm text-gray-500 w-3/5">
        Visconn is a place to connect, share ideas, and join discussions. Engage
        with others through threads, comments, and more.
      </div>
    </div>
  );
};
